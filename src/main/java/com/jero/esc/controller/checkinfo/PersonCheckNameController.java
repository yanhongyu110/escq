...
public class PersonCheckNameController extends BaseController {
    ...
    public ModelAndView viewAddPersonCheck(HttpSession session) throws Exception {
        ...
        if(personCheckname1==null) {
            ...
            modelAndView.setViewName("/checkinfo/personcheck");
            return  modelAndView;
        }else  if (personCheckname1.getPcnState()==1){
            modelAndView.addObject("title", "审核结果");
            modelAndView.addObject("content", "正在审核。请等待！");
            modelAndView.addObject("url", "/checkinfo/perosonCheckName/viewAddPersonCheck.html");
    ...
    public ModelAndView viewPersonCheck(){
        ...
        modelAndView.setViewName("/checkinfo/perosonCheckName/viewAddPersonCheck.html");
        return  modelAndView;
    }
    ...
    public String addPersonCheck(HttpSession session,PersonCheckname personCheckname){
        ...
        return new JsonResult(true,"添加成功","/checkinfo/perosonCheckName/viewAddPersonCheck.html").toJSON();
