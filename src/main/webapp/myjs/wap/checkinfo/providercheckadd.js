      ...
      //上传图片
        ...
        /*    if (window.PIE) {
            ...
            $(".excit:contains('上一步')").click(function () {
                ...
                $('.upli').each(function () {
                    var li = $(this);
                    li.css({"width": "64%","line-height": "110px",border: "1px solid #5BABE6",height:'auto'});
                    try {
            ...
            var timeout=function(){
             ...
             //提交
             $(".excit:contains('提交')").click(function (){
            	 var validate=true;
            	...
            	/* var piBrief=$("#piBrief").val();
             	...
             	if(validate){
                  $.ajax({
                      type : "POST",
                      url : path+"/wap/checkinfo/providerCheck/addCheckInfo.html",
                      data :temp,
