...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			...
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/goodsinfo/cart/showCartList.html'"><li>心愿单</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/bizinfo/focus/showFocusList.html'"><li>关注表</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/bizinfo/collectUtod/myCollects.html'"><li>收藏夹</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
