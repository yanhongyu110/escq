...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			<ul class="list_phto">
				<li class="list_phto_img"><img src="${user.userPhoto}"></li>
				<li class="list_title">${user.logName}
                   <br><span>高级资深美工设计</span>
                   <br><span>0人约见</span>
                </li>
				<li class="list_more" style="float: left;width: 50%">${user.userRealName}</li>
			</ul>
			...
			<ul class="list_mes have_border" onclick="window.location.href=path+'/wap/details/AccountPaymentDetails/showIODetails.html'">
				<li class="money">我的账户</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>

            <ul class="list_mes" onclick="window.location.href=path+'/wap/saleinfo/orderInfoBuyer/orderView.html'">
				<li class="yy">我的预约</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>

			<ul class="list_mes" onclick="window.location.href=path+'/wap/userinfo/jumpmodifyUserInfo.html'">
				<li class="zj">个人设置</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>
			<ul class="list_mes" onclick="window.location.href=path+'/wap/bizinfo/focus/gotoFocusMenu.html'">
