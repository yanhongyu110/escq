...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			...
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/demand/gotoDemandListAdmin.html'"><li>需求列表</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/demand/gotoAddDemand.html'"><li>需求发布</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
