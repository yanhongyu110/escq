...
<link rel="stylesheet" href="${webtxc }/css/wap/personer.css?val=1234" />
...
<script type="text/javascript" src="${webtxc }/myjs/wap/saleinfo/refunddetails.js?v=4"></script>
				...
				<div class="refund_wap">
					<div class="personer_mes">
						<div class="personer_mes_zl">
							...
							<ul class="personer_mes_zl_ms" style="height:100px;line-height:100px;padding-top:20px;padding-bottom:20px;">
								<li>退款理由：</li>
								<li class="mes_input" >
										<input type="hidden" id="orderNo" value="${orderInfo.orderNo}"/>
										<input type="hidden" id="refundprice" value="${orderInfo.orderPrice}"/>
										<input type="hidden" id="refundstate" value="${orderInfo.orderRefundstate}"/>
									<textarea type="text" id="buyerrepaycontent" placeholder="请表明退款原因" value="${orderInfo.orderBuyerrepaycontent}" disabled>${orderInfo.orderBuyerrepaycontent}</textarea>
								</li>
							</ul>
							<ul class="personer_mes_zl_ms"  style="height:100px;line-height:100px;padding-top:20px;padding-bottom:20px;">
								<li>专家说明：</li>
								<li class="mes_input" >
									<textarea type="text" id="orderSellerrepaycontent" placeholder="专家还没有同意，所以没有说明" value="${orderInfo.orderSellerrepaycontent}" disabled>${orderInfo.orderSellerrepaycontent}</textarea>
								</li>
							</ul>
							...
							<ul class="personer_mes_zl_ms"  style="height:100px;line-height:100px;padding-top:20px;padding-bottom:20px;">
								<li >平台说明：</li>
								<li class="mes_input" >
									<textarea type="text" id="orderAdminrepaycontent" placeholder="专平台审核中。。。" value="${orderInfo.orderAdminrepaycontent}" disabled>${orderInfo.orderAdminrepaycontent}</textarea>
								</li>
							</ul>
										
							<%--<c:if test="${orderInfo.orderRefundstate<1 }">
								<ul class="personer_mes_zl_ms">
									<li class="mes_input" style="width: 50%;">
										
										<div style="cursor:pointer;background: #FB5A5A;color: white;margin: 0 auto;width: 60%;height: 100%;text-align: center;"   onclick="applyrefund()">申请</div>
									</li>
									<li class="mes_input" style="width: 50%;">
										<div class="mes_btn_qx" style="cursor:pointer;background: #CCC;color: #999;margin: 0 auto;width: 60%;height: 100%;text-align: center;" onclick="reset()">取消</div>
									</li>
								</ul>
							</c:if>--%>
