						...
						<div class="service_content_pj show">
							...
							<div class="personer_mes_zl">
								...
								<ul class="personer_mes_zl_ms">
									<li>联系人</li>
									<li class="mes_input" style="width:48%;">
										<input id="orderPerson" type="text" placeholder="请输入姓名"  />
									</li>
									<li id="orderPersonicon"  style="width:22%;float:right;font-size:12px;text-align: right;"></li>
								</ul>
								<ul class="personer_mes_zl_ms">
									<li>约定区域</li>
									<li class="mes_input" style="width:48%;">
									...
									<li id="orderAreaicon" style="width:22%;float:right;font-size:12px;text-align: right;"></li>
								</ul>
								<ul class="personer_mes_zl_ms">
									<li>约定地点</li>
									<li class="mes_input" style="width:48%;">
									...
									<li id="orderAddricon" style="width:22%;float:right;font-size:12px;text-align: right;"></li>
								</ul>
								<ul class="personer_mes_zl_ms">
									<li>联系方式</li>
									<li class="mes_input" style="width:48%;">
									...
									<li id="orderPersoncellicon" style="width:22%;float:right;font-size:12px;text-align: right;"></li>
								</ul>
