...
//			    $('.list_mes > li:nth-child(2)').css({"line-height": "2"})
            $('.upli').each(function () {
                var li = $(this);
                li.css({"width": "60%", "line-height": "110px", border: "1px solid #eee", height: 'auto',"background-size": "contain"});
        ...
        <div class="personer_mes">
            ...
            <div class="personer_mes_zl">
                <ul class="personer_mes_zl_ms item">
                    ...
                    <li class="mes_input"><%--  ${userInfoVo.userRealName} --%>
                        <input type="text" class="piRealname" name="piRealname" />
                    </li>
                ...
                <ul class="personer_mes_zl_ms item">
                    <li>所在地址</li>
                    <li class="mes_input_rr"><input type="text" class="mees piAddr" name="piAddr" placeholder="右边搜索框添加" readonly="readonly"></li>
            ...
            <div class="personer_mes_zl ">
                ...
                <div class="personer_excit">
                    ...
                    <div > <button class="excit" type="button" >提交</button></div>
                </div>
