...
<html>
	...
	<head>
		...
		<link rel="stylesheet" href="${webtxc}/css/wap/personer.css" />
		<script type="text/javascript" src="${webtxc }/myjs/wap/goodsinfo/serviceProvider.js"></script>
		<script>
			$(function() {
				if($("#myflag").val()==1){
	...
	<body>
		<input id="myflag" type="hidden" name="myflag" value="">
				...
				<div class="my_date_bt">
					<div class="title cf" style="position: relative">
						<ul class="title-list fr cf ">
							<li class="on" style="width:50%;" data-type="1" onclick="selectCommonAjax(1,1)">优质服务</li>
							<li style="width:50%;" data-type="2" onclick="selectCommonAjax(1,2)">好评服务商</li>
							<p style="width:50%;"></p>
						</ul>
					</div>
					<div class="service_content" >
						<!-- 系统消息 -->
						<div id="ms1" class="service_content_pj show">
						...
						<!-- 平台消息 -->
						<div id="ms2" class="service_content_pj ">
							<div class="personer_mes">
							</div>
						</div>
						<!--end.service_content_pj-->
