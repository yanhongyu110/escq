            ...
            success: function (data) {
                ...
                if(typeof(typeList)!="undefined"){
	                for (var i = 0; i < typeList.length; i++) {
	                    ...
	                    $("#mmyull").append("<li style='color:#fff;text-align:center;height:50px;line-height:50px;border-bottom: 1px solid rgba(255,255,255,.1);' val=" + id + ">" + commonType + "</li>");
	                }
                }
            }
        })
        ...
        <div class="lanrenzhijia">
            ...
            <div class="product-wrap">
                ...
                <div class="product show">
                    ...
                    <div onclick="$('.cellPhone').val('')" style="background: url(${webtxc}/images/wrong.jpg) no-repeat;width: 19px;height: 19px;background-size: 19px;position: absolute;top: 22px;right:10px;"></div>
                    <input type="password" class="login_btn logPassWord" placeholder="至少输入8个字符"/>
                    <div onclick="$('.logPassWord').val('')" style="background: url(${webtxc}/images/wrong.jpg) no-repeat;width: 19px;height: 19px;    background-size: 19px;position: absolute;top: 73px;right:10px;"></div>
                    ...
                    <div class="p_bttom">
                        ...
                        <div class="dl_qt">
                            <a class="qq_dl" href="javascript:toLogin();"></a> <a
                                class="wx_dl"></a>
                        </div>
                    </div>
                </div>
