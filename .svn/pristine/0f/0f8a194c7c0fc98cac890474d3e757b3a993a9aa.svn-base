				...
				<div class="content_top">
					...
					<c:if test="${sessionScope.logInfo.logId!=serviceVo.logId }">
						<div class="content_right_share">
							...
							<a id="zan" style="cursor: pointer;padding-top: 25px;font-size: 16px;color:#999"><img style="width: 16px;margin-right: 5px;"/><span id="zanNum" style="color:#999">${serviceVo.serviceZanNum != null ? serviceVo.serviceZanNum : 0}</span></a>
						</div>
					</c:if>
				...
				<div class="content_left_content">
					...
					<div class="service_content">
						...
						<div class="service_content_pj">
							...
							<div class="note_message zwpj" ><h3><Strong>暂无评价</Strong></h3></div>
