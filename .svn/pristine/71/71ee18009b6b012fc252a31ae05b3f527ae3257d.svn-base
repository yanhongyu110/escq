...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			...
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/userinfo/queryAllSystemMes.html?smType=2'"><li>系统消息</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/userinfo/queryAllSystemMes.html?smType=1'"><li>平台消息</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
