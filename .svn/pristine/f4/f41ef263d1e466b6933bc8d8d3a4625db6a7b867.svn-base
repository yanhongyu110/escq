...
<html>
	...
	<style>
	body{background:#fff}
	.add_sp{width:90%;margin:30px auto;}
	.add_sp_title{width:100%;clear:both;margin-bottom:10px;overflow: hidden;}
	.add_sp_title .sp_bt{float:left;width:20%;height: 30px;line-height: 30px;}
	.add_sp_title .sp_input{float:left;margin-left:5%;width:70%}
	ul,li{list-style:none;}
	.sp_input{border:1px solid #f8f8f8;height: 30px;line-height: 30px;}
	.add_sp_title .sp_shangchuan{float:left;margin-left:5%;width:70%;height:150px;background:#f8f8f8;}
...
<body>
 <div class="add_sp">
	   ...
	   <div class="add_sp_title">
	      <ul>
	        <li class="sp_bt">视频上传</li>
	        <li>
	        <div id="videoSrc">
		        <video controls="controls" hidden="
		        true" height="300px" width="300px">
		        </video>
	        </div>
	 ...
	 <div id="textEle" hidden="true">
		 <input type="text" readonly="readonly" id="readonly"/>
		 <a href="javascript:addVideo()">上传</a>
	 </div>
