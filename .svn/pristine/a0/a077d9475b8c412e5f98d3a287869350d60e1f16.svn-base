...
//			Element config = doc.getRootElement();
			...
			String appid = "wxd0c763640d4b8f08";// 微信分配的公众账号ID（企业号corpid即为此appId）
			String mchid = "1486272382";// 微信支付分配的商户号
			// 设置支付参数
			...
			FileInputStream instream = new FileInputStream(new File("D:/workspace/escq/src/main/webapp/apiclient/apiclient_cert.p12")); // 从配置文件里读取证书的路径信息
//			FileInputStream instream = new FileInputStream(new File("E:/service/tomcat7/service704/webapps/esc/apiclient/apiclient_cert.p12")); // 从配置文件里读取证书的路径信息
