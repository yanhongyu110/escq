...
<html>
	...
	<head>
    	...
    	<link rel="stylesheet" type="text/css" href="${webtxc}/map/wapmap.css?v=12323">
    	<script type="text/javascript" src="${webtxc}/map/map.js?val=123"></script>
    	<script type="text/javascript" src="${webtxc}/myjs/wap/checkinfo/providercheckupdate.js?val=125"></script>
			...
			<div id="page">
				...
				<div class="personer_mes">
					...
					<div class="personer_mes_zl">
						...
						<ul class="personer_mes_zl_ms item">
							<li>所在地址</li>
							<li class="mes_input_rr"><input type="text" class="mees piAddr"  name="piAddr"  value="${providerInfo.piAddr}" placeholder="点击右边搜索框添加" readonly="readonly" ></li>
                            <li><input type="button" value="点击定位"  map-start map-click="sss"></li>
							<span class="personer_mes_ts"></span>
						</ul>
						<div class="personer_excit">
					<div class="excit" style="margin-bottom:10px">下一步</div>
				</div>
					</div>
					<%-- <div class="personer_mes_zl">
		
						<ul class="personer_zp item">
							<li>上传名片 <span class="personer_mes_ts">*必填</span></li>
					...
					<div class="personer_mes_zl ">
						...
						<ul class="personer_media item">
							...
							<li class="shz_img">
							<img class="personer_sc upload imgUrl" src="${providerInfo.piPhoto}"></img>
							</li>
						...
						<ul class="personer_media item">
							...
							<li class="per_textarea"><textarea class="piContent " name="piContent" placeholder="对自己进行简单的介绍，，，（不超过300字）">${providerInfo.piContent}</textarea></li>
							<!-- <span class="personer_mes_ts">*选填</span> -->
						</ul>
						<div class="personer_excit">
...
<%@ include file="/WEB-INF/jsp/wap/common/bottom.jsp"%>
	...
	if(${providerCheckInfo.pciState == 3}){
		alert("认证未通过， 请修改后重新提交！");
	}
