...
import com.jero.esc.common.utils.wechat.entity.refund.RefundReq;
 ...
 */
public class QueryRefundBusiness {
    private final Log log = LogFactory.getLog(QueryRefundBusiness.class);

    public String sendPost(QueryRefundReq queryRefundReq) throws Exception {

 /*       SortedMap<Object, Object> parameters = new TreeMap<Object, Object>();
        parameters = Util.beanToMap(queryRefundReq, true, parameters);
        ...
        String resXml = HttpsRequest.postData(Configure.REFUND, requestXML);
