...
<style>
.personer_excit{position: inherit;margin-top: 20px;}
</style>
<body>
<!--wapper-->
	...
	<div id="page">
		...
		<div class="personer_mes">
			<ul class="list_phto">
				...
				<li class="shiming"><img src="${webtxc }/images/wap/ewm.jpg" onclick="openErweima()"></li>
			</ul>
			...
			<ul class="list_mes clearfix list_mes_father have_border" <%--onclick="window.location.href=path+'/wap/details/AccountPaymentDetails/showIODetails.html'"--%>>
				<li class="money" onclick="window.location.href=path+'/wap/details/AccountPaymentDetails/showIODetails.html?logId=${user.userLogId}'">我的账户</li>
				<li class="mm" onclick="window.location.href=path+'/wap/details/AccountPaymentDetails/showIODetails.html?logId=${user.userLogId}'"></li>
			</ul>
			<!--  
			...
			<%-- 系统消息 --%>
			<ul class="list_mes clearfix list_mes_father">
				<li class="news" onclick="window.location.href=path+'/wap/userinfo/queryAllSystemMes.html?smType=2'">我的消息</li>
		...
		<!-- 二维码 -->
		<style>
		.s_ewm{display:none;background:#fff;width:100%;margin:0 auto;text-align: center;}
		.s_ewm p{padding:10px 0;}
		</style>
