...
<div class="wapper" style="border:0;">
    ...
    <div id="page">
        ...
        <div class="personer_mes_phto">
            ...
            <div class="yue">账户余额（元）<span>常见问题</span></div>
            <div class="jine" id="money">${accList[0].accBalance}</div>
                </c:if>
        ...
        <ul id="withDraw" class="list_mes list_mes_father  have_border" onclick="window.location.href='${webtxc}/wap/userinfo/showWithDraw.html?money=${accList[0].accBalance}&logId=${accList[0].logId }'">
                <li>提现</li>
                <li class="mm"></li>
            </ul>
