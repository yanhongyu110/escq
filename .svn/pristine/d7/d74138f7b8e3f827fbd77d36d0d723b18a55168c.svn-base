...
<script type="text/javascript"
	src="${webtxc}/myjs/userinfo/modifyPayPass.js?v=2016053004"></script>
			...
			<div class="content-right">
				<div class="expert_mes">
					...
					<div class="my_zl_gr">
						...
						<ul>
							<li class="mc">手机号码：</li>
							<li><input type="text" id="logCell" class="gr_input" value="${sessionScope.logInfo.logCell}" disabled="true"　readOnly="true"/></li>
							<li class="hq_yzm" id="getvalidate">获取验证码</li>

						</ul>
						<ul>
							<li class="mc">手机验证码：</li>
							<li><input type="text" id="xfjcheck" placeholder="请输入正确的验证码" class="gr_input" /></li>
						</ul>
						<ul>
							<li class="mc">新支付密码：</li>
							<li><input type="password" class="gr_input" id="newPass"
								placeholder="至少输入6个字符"/></li>
