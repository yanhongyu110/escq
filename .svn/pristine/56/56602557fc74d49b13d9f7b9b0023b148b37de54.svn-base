...
<html>
	<head>
		...
		<script type="text/javascript" src="${webtxc}/myjs/details/accountPaymentDetails.js"></script>
			...
			<div class="content">
				...
				<div class="content-right">
					<div class="expert_mes">
						...
						<form id="myform" action="${webtxc}/details/AccountPaymentDetails/showIODetailsByAjax.html" method="post">
							
							<input name="startTime" id="startTime" type="text"/>
							<span>一</span>
							<input name="endTime" id="endTime" type="text"/ >
							<span style="visibility:hidden;">一</span>
							<select id="cc" class="easyui-combobox" editable="false" style="height:33px;width:160px" name="flag" >
