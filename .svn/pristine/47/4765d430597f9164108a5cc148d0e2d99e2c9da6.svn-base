package com.jero.esc.common.utils.wechat.utils.report.protocol;
...
public class ReportReqData {
     ...
     */
    public ReportReqData(String deviceInfo, String interfaceUrl,int executeTimeCost, String returnCode,String returnMsg,String resultCode,String errCode,String errCodeDes){
        ...
        //根据API给的签名规则进行签名
        /*String sign = Util.createSign(toMap());*/
	...
	public void setExecute_time_cost(int execute_time_cost) {
		this.execute_time_cost = execute_time_cost;
	}
	...
	public SortedMap<Object,Object> toMap(){
		SortedMap<Object,Object> map = (SortedMap<Object, Object>) new HashMap<Object, Object>();
