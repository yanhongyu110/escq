...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			...
			<ul class="list_mes have_border" onclick="window.location.href=path+'/wap/goodsinfo/cart/showCartList.html'">
				<li class="money">我的心愿</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>

            <ul class="list_mes" onclick="window.location.href=path+'/wap/bizinfo/focus/showFocusList.html'">
				<li class="yy">我的关注</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>

			<ul class="list_mes" onclick="window.location.href=path+'/wap/bizinfo/collectUtod/myCollects.html'">
				<li class="zj">我的收藏</li>
				<li class="mm"><img src="${webtxc}/images/wap/more.png"></li>
			</ul>
