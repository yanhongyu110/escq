...
<div class="wapper">
	...
	<div id="page">
		...
		<div class="personer_mes">
			...
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/userinfo/jumpmodifyUserInfo.html'"><li>个人资料</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/checkinfo/perosonCheckName/viewAddPersonCheck.html'"><li>实名认证</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
			<ul class="list_mes clearfix" onclick="window.location.href=path+'/wap/userinfo/logInfo/jumpForgetPass.html'"><li>修改密码</li><li class="mm"><img src="${webtxc}/images/wap/more.png"></li></ul>
